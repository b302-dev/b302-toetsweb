		...
		<div className={'toetsmodel-component'}>
			...
			>
				...
				<g id="assessmenttasks">
					<GenericEntity
						phase={
							entities[Entities.ASSESSMENT_TASKS].elements[0].phases[
				...
				<g id="assessmentprogram">
					<GenericEntity
						phase={
							entities[Entities.ASSESSMENT_PROGRAMME].elements[0].phases[
								Phases.ACTIVITY_ORIENTED
							]
						}
				...
				<g id="assessmentpolicy">
					<GenericEntity
						phase={
							entities[Entities.ASSESSMENT_POLICY].elements[0].phases[
								Phases.ACTIVITY_ORIENTED
							]
						}
						result={policyResult}
				...
				<g id="assessmentorganisation">
					<GenericEntity
						phase={
							entities[Entities.ASSESSMENT_ORGANISATION].elements[0].phases[
								Phases.ACTIVITY_ORIENTED
							]
						}
				...
				<g id="assessmentliteracy">
					<GenericEntity
						phase={
							entities[Entities.ASSESSMENT_LITERACY].elements[0].phases[
								Phases.ACTIVITY_ORIENTED
							]
						}
